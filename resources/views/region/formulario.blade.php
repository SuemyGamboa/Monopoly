...
<div class="container">
    ...
    <br>
    <br>
        <h2>Formulario de Region</h2>
        <!--Necesita de esto para las imagenes: enctype="multipart/form-data"-->
        <form action="{{ action([App\Http\Controllers\RegionController:: class, 'save']) }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="color" value="{{ $region->color }}">
            </div>
